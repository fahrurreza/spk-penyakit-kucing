...
<div class="flex flex-wrap">
    <div class="w-full px-4">
        ...
        <div class="rounded-t bg-white mb-0 px-6 py-6">
            ...
            <a href="<?php echo e(url('/client')); ?>" class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
                Diagnosa Ulang
            </a>
            </div>
        </div>
...
<?php echo $__env->make('app/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kucing\resources\views/client/hasil.blade.php ENDPATH**/ ?>