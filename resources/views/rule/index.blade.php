...
<div class="flex flex-wrap">
    <div class="w-full px-4">
        ...
        <div class="rounded-t bg-white mb-0 px-6 py-6">
            ...
            <a href="{{url('/rule/create')}}" class="bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="button">
                Input Data
            </a>
            </div>
        </div>
    ...
    <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{url('rule/'.$data->id)}}" method="post">
                        @method('delete') @csrf
