...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
        ...
        <div class="my-6 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
            ...
            <span class="block sm:inline"><?php echo e(session('status_error')); ?></span>
        </div>
        <?php endif; ?>
            <form action="<?php echo e(url('/user/'.$id)); ?>" method="post">
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tv\resources\views/user/edit.blade.php ENDPATH**/ ?>