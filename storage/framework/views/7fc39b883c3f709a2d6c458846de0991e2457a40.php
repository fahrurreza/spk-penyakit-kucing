                ...
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <?php $__currentLoopData = $data['criteria']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $criteria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td class="px-4 py-3">
                                <form action="<?php echo e(url('userhasil')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <center>
                                    <select name="nilai[]">
...
<?php echo $__env->make('userlayouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tv\resources\views/usermatrik/matrik.blade.php ENDPATH**/ ?>