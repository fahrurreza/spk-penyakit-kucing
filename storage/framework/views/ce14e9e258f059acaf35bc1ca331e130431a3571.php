...
<div class="flex flex-wrap mt-4">
            <div class="w-full xl:w-12/12 mb-12 xl:mb-0 px-4">
              ...
              >
                ...
                <div class="block w-full overflow-x-auto">
                    <form method="post" action="<?php echo e(url('/diagnosa')); ?>">
                    <?php echo csrf_field(); ?>
                    <!-- Projects table -->
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kucing\resources\views/diagnosa/index.blade.php ENDPATH**/ ?>