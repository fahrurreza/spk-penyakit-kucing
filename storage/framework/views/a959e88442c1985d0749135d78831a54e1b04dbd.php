...
<main class="h-full pb-16 overflow-y-auto">
    ...
    >
      ...
      >
        ...
        <div class="mt-4 mb-6">
          <!-- Modal title -->
          <form action="<?php echo e(url('/tayangan')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <p class="mb-2 text-lg font-semibold text-gray-700 dark:text-gray-300">
                Form Input Tayangan
            </p>
            <!-- Modal description -->
            <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" type="text" placeholder="Input here..." name="tayangan" autofocus/>
        </div>
                        ...
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <form action="<?php echo e(url('tayangan/'.$tayangan->id)); ?>" method="post">
...
<?php echo $__env->make('layouts/master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tv\resources\views/tayangan/index.blade.php ENDPATH**/ ?>